  ...
  <div class="mobile-menu">
    <ul class="m-menu">
      <!-- <li class="dropdown-submenu">
          <a href="teacher-details.html#">Home</a>
        ...
        <li class="dropdown-submenu">
          <a href="teacher-details.html#">About</a>
          <ul class="mobile-submenu">
        ...
        <li class="dropdown-submenu">
          <a href="teacher-details.html#">Classes</a>
          <ul class="mobile-submenu">
      ...
      <!-- <li class="dropdown-submenu">
          <a href="teacher-details.html#">Teachers</a>
          <ul class="mobile-submenu">
            <li><a href="teachers.html">Teacher</a></li>
            <li><a href="https://labartisan.net/demo/kidsacademy/teacher-detail.html">Teacher Details</a></li>
          </ul>
        </li> -->
      <!-- 
        <li class="dropdown-submenu">
          <a href="teacher-details.html#">Pages</a>
          <ul class="mobile-submenu">
      ...
      <!-- <li class="dropdown-submenu">
          <a href="teacher-details.html#">Blog</a>
          <ul class="mobile-submenu">
      ...
      <!-- <li class="dropdown-submenu">
          <a href="teacher-details.html#">Shop</a>
          <ul class="mobile-submenu">
    ...
    <div class="header-top">
      <div class="container">
        <div class="ht-area">
          ...
          <ul class="right">
            <li><a href="teacher-details.html#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
            <li><a href="teacher-details.html#"><i class="fa fa-behance" aria-hidden="true"></i></a></li>
            <li><a href="teacher-details.html#"><i class="fa fa-dribbble" aria-hidden="true"></i></a></li>
            <li><a href="teacher-details.html#"><i class="fa fa-skype" aria-hidden="true"></i></a></li>
            <li><a href="teacher-details.html#"><i class="fa fa-vimeo" aria-hidden="true"></i></a></li>
            <li><a href="teacher-details.html#"><i class="fa fa-pinterest" aria-hidden="true"></i></a></li>
            <li><a href="teacher-details.html#"><i class="fa fa-rss" aria-hidden="true"></i></a></li>
          </ul>
        </div>
      </div>
    </div>
        ...
        <div class="row no-gutters">
          <nav class="main-menu-area w-100">
            ...
            <!-- <div class="featured_content">
                        <h3><a href="teacher-details.html#">Product Title</a> </h3>
            ...
            <!-- <ul class="menu">
                <li class="dropdown">
                  <a href="teacher-details.html#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a href="teacher-details.html#">Test Multi Step</a>
                      <ul class="dropdown-menu">
                        <li><a href="teacher-details.html#">Menu 2</a></li>
                        <li><a href="teacher-details.html#">Menu 2</a></li>
                        <li><a href="teacher-details.html#">Menu 2</a></li>
                        <li><a href="teacher-details.html#">Menu 2</a>
                          <ul class="dropdown-menu">
                            <li><a href="teacher-details.html#">Menu 3</a></li>
                            <li><a href="teacher-details.html#">Menu 3</a></li>
                            <li><a href="teacher-details.html#">Menu 3</a></li>
                            <li><a href="teacher-details.html#">Menu 3</a>
                              <ul class="dropdown-menu">
                                <li><a href="teacher-details.html#">Menu 4</a></li>
                                <li><a href="teacher-details.html#">Menu 4</a></li>
                                <li><a href="teacher-details.html#">Menu 4</a></li>
                                <li><a href="teacher-details.html#">Menu 4</a></li>
                              </ul>
            ...
            <li class="dropdown">
              <a href="teacher-details.html#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                aria-haspopup="true" aria-expanded="false">Classes <span class="caret"></span></a>
              <ul class="dropdown-menu">
                <li><a href="classes.html">Classes</a></li>
            ...
            <li class="dropdown">
              <a href="teacher-details.html#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                aria-haspopup="true" aria-expanded="false">Teachers <span class="caret"></span></a>
              <ul class="dropdown-menu">
      ...
      <div class="row">
        <div class="col-lg-6 col-xs-12">
          <div class="teacher-image">
            <img src="images/teachers/teacher-details.jpg" alt="teacher image" class="img-responsive">
          </div>
        </div>
        <div class="col-lg-6 col-xs-12">
          <div class="teacher-content">
            ...
            <ul class="social-default">
              <li><a href="teacher-details.html#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
              <li><a href="teacher-details.html#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
              <li><a href="teacher-details.html#"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
              <li><a href="teacher-details.html#"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
              <li><a href="teacher-details.html#"><i class="fa fa-pinterest-p" aria-hidden="true"></i></a></li>
            </ul>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-xs-12">
          <div class="teacher-award">
            ...
            <ul>
              <li>
                <img src="images/teachers/award_01.png" alt="award image" class="img-responsive">
                <span>Aword 2021</span>
              </li>
              <li>
                <img src="images/teachers/award_02.png" alt="award image" class="img-responsive">
                <span>Aword 2015</span>
              </li>
              <li>
                <img src="images/teachers/award_03.png" alt="award image" class="img-responsive">
                <span>Aword 2014</span>
              </li>
              <li>
                <img src="images/teachers/award_04.png" alt="award image" class="img-responsive">
...
Subscribe End here -->
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-sm-6 col-xs-12">
            <div class="footer-item">
              ...
              <ul class="photos">
                <li><a href="teacher-details.html#"><img src="images/sidebar/gallery_01.jpg" alt="gallery image" class="img-responsive"></a>
                </li>
                <li><a href="teacher-details.html#"><img src="images/sidebar/gallery_02.jpg" alt="gallery image" class="img-responsive"></a>
                </li>
                <li><a href="teacher-details.html#"><img src="images/sidebar/gallery_03.jpg" alt="gallery image" class="img-responsive"></a>
                </li>
                <li><a href="teacher-details.html#"><img src="images/sidebar/gallery_04.jpg" alt="gallery image" class="img-responsive"></a>
                </li>
                <li><a href="teacher-details.html#"><img src="images/sidebar/gallery_05.jpg" alt="gallery image" class="img-responsive"></a>
                </li>
                <li><a href="teacher-details.html#"><img src="images/sidebar/gallery_06.jpg" alt="gallery image" class="img-responsive"></a>
                </li>
                <li><a href="teacher-details.html#"><img src="images/sidebar/gallery_07.jpg" alt="gallery image" class="img-responsive"></a>
                </li>
                <li><a href="teacher-details.html#"><img src="images/sidebar/gallery_08.jpg" alt="gallery image" class="img-responsive"></a>
                </li>
                <li><a href="teacher-details.html#"><img src="images/sidebar/gallery_09.jpg" alt="gallery image" class="img-responsive"></a>
                </li>
              </ul>
            </div>
          </div>
  ...
  <a class="page-scroll scroll-top" href="teacher-details.html#scroll-top"><i class="fa fa-angle-up"
